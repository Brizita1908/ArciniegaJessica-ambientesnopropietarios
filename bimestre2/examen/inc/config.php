...
if( !preg_match( "/" . urlencode(DOCUMENT_ROOT_RELATIVA) . 'index.php[\?\w*]?/', urlencode($_SERVER['REQUEST_URI']))  &&
 ...
 $_SERVER['REQUEST_URI'] != DOCUMENT_ROOT_RELATIVA . 'rpc/inisesion.php'&& 
 $_SERVER['REQUEST_URI'] != DOCUMENT_ROOT_RELATIVA . 'rpc/procesar.php'&&
  $_SERVER['REQUEST_URI'] != DOCUMENT_ROOT_RELATIVA . 'rpc/get_materias.php'&&
    $_SERVER['REQUEST_URI'] != DOCUMENT_ROOT_RELATIVA . 'rpc/reg_materias.php'&& 
 $_SERVER['REQUEST_URI'] != DOCUMENT_ROOT_RELATIVA . 'matriculacion.php'){
